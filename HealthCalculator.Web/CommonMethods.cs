        ...
        public static string ChildEmailBody(List<Datum> dt, EnquiryModel collection)
        {
            ...
            if (childAge <=2)
            {
                if (gender == "Female")
                    ...
                    retVal = retVal + string.Format(growthChart,"ShowWFLGirl");
                else if (gender == "Male")
            ...
            else if(childAge >2 && childAge <=5)
            {
                ...
                if (gender == "Female")
                    ...
                    retVal = retVal + string.Format(growthChart, "ShowBMI0205Girl");
                else if(gender == "Male")
            ...
            else if(childAge >5 && childAge <=18)
            {
                ...
                if (gender == "Female")
                    ...
                    retVal = retVal + string.Format(growthChart, "ShowBMI0518Girl");
                else if (gender == "Male")
