...
namespace HealthCalculator.Web.Controllers
{
    ...
    public class PaymentController: BaseController
    {
        ...
        public ActionResult CreateOrder(PaymentInitiateModel _requestData)
        {
            ...
            Razorpay.Api.RazorpayClient client = new Razorpay.Api.RazorpayClient("rzp_test_umbrFAbJ3slyJ", "su9eXFaihGucmKECVRcRk0Q");
        ...
        public ActionResult Complete()
        {
            ...
            Razorpay.Api.RazorpayClient client = new Razorpay.Api.RazorpayClient("rzp_test_umbrFAbVJ3lyJ", "su9eXFaihGucMmKEVRcRk0Q");
